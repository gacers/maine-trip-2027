...
import SiteStackNav from "@/components/SiteStackNav";
...
export default function HomeShell({ isAdmin, isSignedIn, children }: HomeShellProps) {
  ...
  let categoryBasePath: "/categories" | "/future-interest" | undefined;
  let categorySlug: string | undefined;
  if (pathname.startsWith("/categories/")) {
    categoryBasePath = "/categories";
    categorySlug = pathname.split("/")[2];
  } else if (pathname.startsWith("/future-interest/")) {
    categoryBasePath = "/future-interest";
    categorySlug = pathname.split("/")[2];
  }
