...
export const COLLECTIONS = {
  listings: {
    ...
    pageSlug: "/",
    sheetName: "Listings",
    overviewSheetName: "Properties Overview",
    // One-time migration: the tab used to be plainly called "Overview"
    // before every other collection's overview got a distinguishing
    // prefix. If a tab by that old name still exists, it gets renamed in
    // place (see ensureOverviewSheet) instead of leaving it orphaned.
    legacyOverviewSheetName: "Overview",
    label: "House Options",
    navLabel: "Houses",
