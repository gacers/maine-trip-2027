...
export async function exportSection(supabase, trip, section) {
  try {
    ...
    const rows = units.map((u) => buildRow(u, overviewFields, trip, section, siteUrl, inviteToken));
...
function buildRow(unit, overviewFields, trip, section, siteUrl, inviteToken) {
