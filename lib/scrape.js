    ...
    if (!res.ok) {
      ...
      if (html.length < 20000 && /404 Page Not Found|page you.re looking for/i.test(html)) {
        blockedReason = isAirbnb
          ? "Airbnb didn't return this listing's page — the saved session cookie may have expired (an admin can replace AIRBNB_SESSION_COOKIE), or the listing may genuinely be gone."
