...
// listings can defeat all of them the same way they defeat this. Also
// tried and abandoned: a bookmarklet to read the page from the
// visitor's own browser tab instead — technically sound (sidesteps the
// block entirely) but not intuitive for non-technical people and didn't
// hold up in practice. For a listing this can't reach, manual entry
// (already the fallback below) and the AI-agent path are what's left,
// and that's fine — most listings work fine through this file as-is.
